...
This is a modified version of the `features_info.txt` file that came with the raw data. It is modified to document only the data that is
in the tidy dataset found in `tidy.txt`.
